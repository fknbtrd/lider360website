...
export const metadata: Metadata = {
  title: "Производство бетона в Каневской | Доставка по Краю",
  description:
    "Бетон с доставкой в станице Каневской. Цены от производителя. Заказать бетон М300, М200 для фундамента.",
  keywords:
  ...
  openGraph: {
    title: "Производство бетона в Каневской | Доставка по Краю",
    description: "Бетон с доставкой в станице Каневской. Цены от производителя.",
